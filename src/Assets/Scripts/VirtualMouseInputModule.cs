...
/// </remarks>
public class VirtualMouseInputModule : VirtualPointerInput
{
	[SerializeField] private Transform mouseCrosshair;
	...
	private Vector2 MousePos => mouseCrosshair.position;
	...
	{
		var mouseData = GetMousePointerEventData(id, MousePos);
