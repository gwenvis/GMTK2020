...
/// </summary>
public abstract class VirtualPointerInput : BaseInputModule
{
	protected Dictionary<int, PointerEventData> m_PointerData = new Dictionary<int, PointerEventData>();
	private readonly VirtualPointerInput.MouseState m_MouseState = new VirtualPointerInput.MouseState();
	/// <summary>
	...
	/// </summary>
	/// <param name="id"></param>
	protected virtual VirtualPointerInput.MouseState GetMousePointerEventData(Vector3 MousePos)
	{
		return this.GetMousePointerEventData(0, MousePos);
	}
	...
	protected class ButtonState
	{
		...
		private VirtualPointerInput.MouseButtonEventData m_EventData;

		public VirtualPointerInput.MouseButtonEventData eventData
		{
			get
			{
	...
	{
		private List<VirtualPointerInput.ButtonState> m_TrackedButtons = new List<VirtualPointerInput.ButtonState>();
